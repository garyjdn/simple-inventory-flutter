          ...
          if (authState is AuthenticationSuccess) {
            return Drawer(
              ...
              children: <Widget>[
                  ...
                  child: ListView(
                    children: <Widget>[
                      StreamBuilder<QuerySnapshot>(
                          ...
                          builder:
                            ...
                            if (snapshot.connectionState !=
                              ...
                              List<DocumentSnapshot> ds = snapshot
                                  .data.documents
                                  .where((DocumentSnapshot doc) =>
                                      doc.documentID == authState.user.id)
                                  .toList();
                      ...
                      ListTile(
                          ...
                          leading: Icon(FontAwesomeIcons.users, size: 21),
                          title: Text('User')),
                      ListTile(
                          onTap: () async {
                            if (authState.user.role == 'Admin') {
                          ...
                          leading: Icon(FontAwesomeIcons.building, size: 21),
                          title: Text('Station')),
                      Divider(),
                      ListTile(
                          onTap: () {
                      ...
                      ListTile(
                          ...
                          title: Text('About')),
                      ListTile(
                        leading: Icon(FontAwesomeIcons.signOutAlt, size: 21),
                        title: Text('Logout'),
                        onTap: () {
                ...
                Container(
                    height: 40,
                    child: Center(child: Text('V ${appState.version}')))
              ],
            ));
          }
        });
