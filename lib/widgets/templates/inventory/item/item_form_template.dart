                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              DropdownButtonFormField<Category>(
                                value: _selectedCategory ?? state.categories[0],
                                ...
                                onPressed: () {
                                  if (_formKey.currentState.validate()) {
                                    if(widget.action == 'create') {
                                      _itemFormBloc.add(AddItemButtonPressed(
                                        name: _nameCtrl.text,
                                        category: _selectedCategory ?? state.categories[0],
                                        unit: _selectedUnit?? state.units[0]));
