        ...
        builder: (BuildContext context) => CustomDialog(
              ...
              primaryButton: PrimaryButton(
                  onPressed: () {
                    ...
                    _stationBloc
                        .add(DeleteStationButtonPressed(station: station));
                  },
                  text: 'Delete'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          onPressed: () async {
            final fetch = await Navigator.of(context).pushNamed(
                ...
                arguments: StationFormScreenArguments(
                    title: 'Add Station', action: 'create'));

            if (fetch != null && fetch) _stationBloc.add(LoadStationStarted());
          },
        ),
        body: BlocConsumer<StationBloc, StationState>(
          ...
          if (state is StationLoadStarted || state is StationLoadSuccess) {
            return true;
          }
          return false;
                                ...
                                IconButton(
                                  onPressed: () async {
                                    final fetch = await Navigator.of(context)
                                        .pushNamed(StationFormScreen.routeName,
                                            arguments:
