        ...
        builder: (BuildContext context) => CustomDialog(
              ...
              primaryButton: PrimaryButton(
                  onPressed: () {
                    ...
                    _categoryBloc
                        .add(DeleteCategoryButtonPressed(category: category));
                  },
                  text: 'Delete'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          onPressed: () async {
            final fetch = await Navigator.of(context).pushNamed(
                ...
                arguments: CategoryFormScreenArguments(
                    title: 'Add Category', action: 'create'));
        ...
        body: BlocConsumer<CategoryBloc, CategoryState>(
          ...
          if (state is CategoryLoadStarted || state is CategoryLoadSuccess) {
            return true;
          }
          return false;
                                ...
                                IconButton(
                                  onPressed: () async {
                                    final fetch = await Navigator.of(context)
                                        .pushNamed(CategoryFormScreen.routeName,
                                            arguments:
