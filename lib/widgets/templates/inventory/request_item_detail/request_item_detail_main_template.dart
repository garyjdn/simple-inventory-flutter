...
class TmpRequestItemDetailMain extends StatelessWidget {
  ...
  Future deleteDialog(BuildContext ctx, RequestItemDetail requestItemDetail) async {
      ...
      builder: (BuildContext context) => CustomDialog(
        ...
        primaryButton: PrimaryButton(
          onPressed: () {
            ...
            _requestItemDetailBloc.add(DeleteRequestItemDetailButtonPressed(requestItemDetail: requestItemDetail));
          },
          text: 'Delete'
        ),
